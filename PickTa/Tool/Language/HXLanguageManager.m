...
#define NSLocalizedStringTableName @"Localizable1"
...
- (void)initUserLanguage {
    ...
    if(currentLanguage.length == 0){
        NSArray *languages = [NSLocale preferredLanguages]; //获取系统偏好语言数组
        currentLanguage = [languages objectAtIndex:0]; //第一个为当前语言
