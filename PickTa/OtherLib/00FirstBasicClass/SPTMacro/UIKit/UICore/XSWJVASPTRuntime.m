...
@implementation SPTPropertyDescriptor

+ (instancetype)descriptorWithProperty:(objc_property_t)property {
    SPTPropertyDescriptor *descriptor = [[SPTPropertyDescriptor alloc] init];
    ...
    NSString *setterString = setterChar != NULL ? [NSString stringWithUTF8String:setterChar] : [SPTPropertyDescriptor defaultSetterStringWithPropertyName:propertyName];
    ...
    descriptor.type = [SPTPropertyDescriptor typeWithEncodeString:[NSString stringWithUTF8String:type]];
    if (type != NULL) {
        free(type);
    }
...
- (NSString *)description {
    ...
    if (self.setter != NSSelectorFromString([SPTPropertyDescriptor defaultSetterStringWithPropertyName:self.name])) [result appendFormat:@", setter=%@", NSStringFromSelector(self.setter)];
    [result appendString:@") "];
