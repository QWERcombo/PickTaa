...
/**
 * `XSWJVASPTUILabel`支持通过`contentEdgeInsets`属性来实现类似padding的效果。
 *
...
@interface XSWJVASPTUILabel : UILabel
...
/// 点击了“复制”后的回调
@property(nonatomic, copy) void (^didCopyBlock)(XSWJVASPTUILabel *label, NSString *stringCopied);
