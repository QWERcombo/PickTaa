...
@interface PTMyHuoYueDuVC () <UITableViewDelegate, UITableViewDataSource, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
@property (nonatomic, strong) PTHYDListModel *listModel;
@end
@implementation PTMyHuoYueDuVC
...
- (void)bindViewModel {
    ...
    [self.vm.myHYD.executionSignals.switchToLatest subscribeNext:^(id  _Nullable x) {
        @strongify(self)
        ...
        if ([x isKindOfClass:[NSError class]]) {
            ...
            PTHYDListModel *model = (PTHYDListModel *)x;
...
- (void)setupNavBar {
    self.title = kLocalizedString(@"my_active", @"我的活跃度");
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView {
    NSString *text = String_IsEmpty(self.emptyString) ? kLocalizedString(@"my_active_list", @"我的活跃度记录") : self.emptyString;
...
- (PTMyMHGHeadTVC *)headView {
    if (!_headView) {
        ...
        self.headView.titleTagView.backgroundColor = COLOR_HEX_RGB(0xFDCC187);
        self.headView.titleLbl.text = kLocalizedString(@"my_active_list", @"我的活跃度记录");
        self.headView.titleLbl11.textColor = COLOR_HEX_RGB(0xFFFFFF);
        self.headView.titleLbl12.textColor = COLOR_HEX_RGB(0xFFFFFF);
        ...
        self.headView.valueLbl11.text = @"0.00";
        self.headView.valueLbl12.text = @"0.00";
        self.headView.valueLbl21.text = @"0.00";
        self.headView.valueLbl22.text = @"0.00";
        self.headView.valueLbl31.text = @"0.00";
    }
