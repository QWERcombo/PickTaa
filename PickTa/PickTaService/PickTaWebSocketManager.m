...
@interface PickTaWebSocketManager()<SRWebSocketDelegate>{
...
@implementation PickTaWebSocketManager

+ (instancetype)share
{
    static dispatch_once_t onceToken;
    static PickTaWebSocketManager *instance = nil;
...
- (void)initSocket
{
    ...
    webSocket = [[SRWebSocket alloc]initWithURL:[NSURL URLWithString:@"ws://www.pickta.net/socket.io?uid=250303"]];
